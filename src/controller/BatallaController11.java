 ...
 * @author LabInfo01
 */
public class BatallaController11 extends javax.swing.JFrame {

    /**
     * Creates new form BatallaController1
     */
    public BatallaController11() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BatallaController11.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BatallaController11().setVisible(true);
            }
        });
    }
...
private BatallaService batallaService = new BatallaServiceImpl();
    ...
    public void obtenerBatallas(){
        for(Batalla j:batallaService.obtenerRegistros()){
            DefaultTableModel model = (DefaultTableModel) this.jTable1.getModel();
            model.addRow(new Object[]{ j.getId(),j.getCantidad()});
        }
    }
